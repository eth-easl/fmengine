...
from fmengine.config import LlamaConfig, ParallelismArgs
...
from fmengine.random import RandomStates
from fmengine.utils import checkpoint_method
from fmengine.nn.mlp import MLP
...
class CausalSelfAttention(nn.Module, AttachableStore):
    def __init__(
        ...
        self.flash_rotary_embedding = FlashRotaryEmbedding(
            dim=self.d_qk, interleaved=True
        )
