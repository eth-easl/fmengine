...
def fused_chunk_gla_bwd_kernel(
    ...
    for i in range(0, n_chunks):
        ...
        b_dq += tl.dot(b_do, b_h.to(b_do.dtype), allow_tf32=False) * scale
        # [DV, DK]
    ...
    for i in range(1, tl.cdiv(T, BT) + 1):
        ...
        # inter-chunk
        b_dk = (
            tl.trans(tl.dot(b_dh.to(b_v.dtype), tl.trans(b_v), allow_tf32=False))
            * scale
        )
