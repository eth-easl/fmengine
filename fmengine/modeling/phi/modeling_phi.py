...
class PhiMLP(nn.Module):
    def __init__(self, config):
        ...
        self.fc1 = te.Linear(config.hidden_size, config.intermediate_size)
        self.fc2 = te.Linear(config.intermediate_size, config.hidden_size)
...
class PhiAttention(nn.Module):
    ...
    def __init__(self, config: PhiConfig, layer_idx: Optional[int] = None):
        ...
        self.query_key_value = te.Linear(self.hidden_size, 3 * self.hidden_size, bias=True)
        self.dense = te.Linear(self.num_heads * self.head_dim, self.hidden_size, bias=True)
...
class PhiForCausalLM(PhiPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.vocab_size = config.vocab_size
        self.lm_head = te.Linear(config.hidden_size, config.vocab_size, bias=True)
...
class PhiForTokenClassification(PhiPreTrainedModel):
    def __init__(self, config: PhiConfig):
        ...
        self.classifier = te.Linear(config.hidden_size, config.num_labels)
